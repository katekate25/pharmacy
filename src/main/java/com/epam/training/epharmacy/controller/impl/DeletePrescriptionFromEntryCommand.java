...
public class DeletePrescriptionFromEntryCommand implements Command {
    private final Logger LOG = LogManager.getLogger(DeletePrescriptionFromEntryCommand.class);
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            orderService.deletePrescriptionFromEntry(Integer.valueOf(req.getParameter("entryNumber")), Integer.valueOf(req.getParameter("prescrNumber")));
