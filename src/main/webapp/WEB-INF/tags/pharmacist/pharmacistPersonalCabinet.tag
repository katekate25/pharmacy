...
<%@ attribute name="pharmacist" required="true" type="com.epam.training.epharmacy.entity.User"%>
...
<form class="form-horizontal" action = "/pharmacy/controller" method = "post">
   ...
   <div class="form-group">
        ...
        <div class="col-sm-3">
            <input class="form-control" type="text" name="userName" value="${pharmacist.fullName}">
        </div>
   </div>
   <div class="form-group">
        <label class="col-sm-2 control-label"><fmt:message bundle="${loc}" key="local.email" /></label>
        <div class="col-sm-3">
            <input class="form-control" type="text" name="email" value="${pharmacist.email}">
        </div>
   </div>
   <div class="form-group">
        <label class="col-sm-2 control-label"><fmt:message bundle="${loc}" key="local.telephone" /></label>
        <div class="col-sm-3">
            <input class="form-control" type="text" name="telNumber" value="${pharmacist.telNumber}">
        </div>
   </div>
   <div class="form-group">
